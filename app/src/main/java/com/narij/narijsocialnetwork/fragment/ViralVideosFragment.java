 ...
 */
public class ViralVideosFragment extends Fragment implements FlexibleAdapter.EndlessScrollListener {
    ...
    private void initializeRecyclerView() {
        ...
        Call<PostsRetrofitModel> call = apiInterface.getViral(Globals.token, MediaType.VIDEO);
        ...
        call.enqueue(new Callback<PostsRetrofitModel>() {
            ...
            public void onResponse(Call<PostsRetrofitModel> call, Response<PostsRetrofitModel> response) {
                ...
                mAdapter.setDisplayHeadersAtStartUp(true) //Show Headers at startUp!
                        ...
                        .setEndlessScrollListener(ViralVideosFragment.this, new ProgressItem())
