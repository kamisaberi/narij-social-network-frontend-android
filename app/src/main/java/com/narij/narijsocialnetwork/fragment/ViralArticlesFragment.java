 ...
 */
public class ViralArticlesFragment extends Fragment implements FlexibleAdapter.EndlessScrollListener   {
...
//                    InstagramHeaderItem header= new InstagramHeaderItem("H" + post.getPostId());
                ...
                mAdapter.setDisplayHeadersAtStartUp(true) //Show Headers at startUp!
                        ...
                        .setEndlessScrollListener(ViralArticlesFragment.this, new ProgressItem())
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_viral_articles, container, false);
    }
...
//        Call<PostsRetrofitModel> call = apiInterface.getViral(Globals.token, MediaType.TEXT);
//        call.enqueue(new Callback<PostsRetrofitModel>() {
//            @Override
//            public void onResponse(Call<PostsRetrofitModel> call, Response<PostsRetrofitModel> response) {
//
